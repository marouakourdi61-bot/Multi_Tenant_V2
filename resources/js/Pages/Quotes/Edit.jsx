...
export default function Edit({ quote }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        general_discount: quote.general_discount || 0,
        general_discount_type: quote.general_discount_type || '%',
        notes: quote.notes || '',
        concluding_text: quote.concluding_text || '',
            ...
            <form onSubmit={submit}>
                ...
                <header className="sticky top-0 z-40 bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 shadow-sm">
                    <div className="flex items-center gap-4">
                        <span className="text-lg font-semibold text-indigo-600">Modifier Devis</span>
                        <span className="text-sm text-gray-400">#{quote.quote_number}</span>
                        <select
                            value={data.status}
